...
class _MyAppState extends State<MyApp> {
  ...
  callListener() async {
    ...
    await channel.invokeMethod("askPermission");
  }
  ...
  void _onUSB(usbEvent) {
    try {
      if (usbEvent.hasPermission) {
        ...
        SnackBarService.showSnackBar(content: subscription.toString());
      } else {
      ...
      setState(() {
        _device = usbEvent;
        SnackBarService.showSnackBar(content: _device!.deviceId.toString());
      });
    } catch (e) {
      setState(() {
        _error = "_onUSB " + e.toString();
      });
      SnackBarService.showSnackBar(content: _error);
    }
  }
